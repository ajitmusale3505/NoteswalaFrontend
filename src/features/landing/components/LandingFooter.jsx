import { FiArrowRight, FiBookOpen, FiGithub, FiInstagram, FiLinkedin, FiMail, FiYoutube } from "react-icons/fi";
    ...
    <>
      <section className="cta-section" id="cta">
        <div className="shell cta-inner reveal">
          ...
          <div className="cta-actions"><a className="button button-dark" href="#top">Create Free Account <FiArrowRight /></a><a className="button button-outline" href="#resources">Explore Platform</a></div>
        </div>
      </section>
      <footer className="site-footer">
        <div className="shell footer-grid">
          <div className="footer-brand"><a className="brand" href="#top"><span className="brand-mark"><FiBookOpen /></span><span>EduHub</span></a><p>Your Complete Engineering Companion</p><div className="socials"><a href="#top" aria-label="GitHub"><FiGithub /></a><a href="#top" aria-label="YouTube"><FiYoutube /></a><a href="#top" aria-label="LinkedIn"><FiLinkedin /></a><a href="#top" aria-label="Instagram"><FiInstagram /></a></div></div>
